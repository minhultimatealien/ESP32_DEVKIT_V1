...
url = "https://api.openweathermap.org/data/2.5/weather?id=1566083&units=metric&appid=" + settings["open_weather_key"]   # Using location ID
# url = "https://api.openweathermap.org/data/3.0/onecall/timemachine?lat=39.099724&lon=-94.578331&dt=1643803200&appid=" + settings["open_weather_key"]
...
#url = "https://api.openweathermap.org/data/2.5/weather?q=London&appid=" + settings["open_weather_key"]
